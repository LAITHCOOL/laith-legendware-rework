...
struct NetvarData_t
{
	...
	Vector m_angAimPunchAngle = Vector(0.f, 0.f, 0.f);
	Vector m_angViewPunchAngle = Vector(0.f, 0.f, 0.f);
};
...
public:
	...
	//virtual float GetMaxSpeed(player_t* pPlayer = g_ctx.local());
...
protected:
	...
	// save last cmd
	CUserCmd* m_LastPredictedCmd = NULL;
};
