...
public:
    ...
    //    return ((int(__thiscall*)(player_t*, const char*))LookupSequencet)(this, name);
    //}

    //__forceinline AnimationLayer* GetAnimationOverlay(int i)
    //{
    ...
    //{
    //    AnimationLayer* pLayer = this->GetAnimationOverlay(layer);

    //    return pLayer->m_flWeight;
    //}
    //float GetSequenceCycleRate(CStudioHdr* hdr, int sequence) {
    //    return util::get_method<float(__thiscall*)(void*, CStudioHdr*, int)>(this, 221U)(this, hdr, sequence);
    //}


    //__forceinline void GetSequenceLinearMotion(CStudioHdr* hdr, int sequence, float* poseparameter, Vector* out) {
    //    using GetSequenceMoveDist_t = void(__fastcall*)(CStudioHdr*, int, float*, Vector*);

    //    //XOR( "55 8b ec 83 ec ? 56 8b f1 57 8b fa 85 f6 75 ? 68" ) );
    //    uintptr_t GetSequenceLinearMotiont = util::FindSignature("client.dll", "55 8b ec 83 ec ? 56 8b f1 57 8b fa 85 f6 75 ? 68");

    //    ((GetSequenceMoveDist_t)GetSequenceLinearMotiont)(hdr, sequence, poseparameter, out);
    //    __asm add esp, 8
    //}

    //__forceinline float GetSequenceMoveDist(CStudioHdr* hdr, int sequence) {
    //    Vector vReturn;
    //    GetSequenceLinearMotion(hdr, sequence, (float*)((DWORD)this + 0x2774), &vReturn);
   ...
   // CUSTOM_OFFSET(GetMoveType, int, 0x25C);
    ...
    void set_animation_state(C_CSGOPlayerAnimationState* state);
